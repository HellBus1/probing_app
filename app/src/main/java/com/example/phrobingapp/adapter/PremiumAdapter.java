...
public class PremiumAdapter extends SliderViewAdapter<PremiumAdapter.SliderViewHolder> {

    private List<Iklan> list_iklan;
    public PremiumAdapter(List<Iklan> list_pelanggan){
    ...
    static class SliderViewHolder extends SliderViewAdapter.ViewHolder {
        ...
        SliderViewHolder(View itemView) {
            super(itemView);
            promo = itemView.findViewById(R.id.petuah);
        }
    }
}
