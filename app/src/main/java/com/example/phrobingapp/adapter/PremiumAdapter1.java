...
public class PremiumAdapter1 extends SliderViewAdapter<PremiumAdapter1.SliderViewHolder> {

    private List<Iklan> list_iklan;
    public PremiumAdapter1(List<Iklan> list_pelanggan){
        this.list_iklan = list_pelanggan;
    }

    @Override
    public SliderViewHolder onCreateViewHolder(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_item_one, null);
    ...
    static class SliderViewHolder extends SliderViewAdapter.ViewHolder {
        ...
        SliderViewHolder(View itemView) {
            super(itemView);
            promo = itemView.findViewById(R.id.petuah1);
        }
    }
}
